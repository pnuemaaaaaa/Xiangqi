...
public class Soldier extends Piece {
    ...
    public List<Position> getPossibleMoves(List<Piece> allPieces){
        ...
        Position pos1 = new Position(nowX+1,nowY);
        Position pos2 = new Position(nowX-1,nowY);
        Position pos3 = new Position(nowX,nowY+1);
        Position pos4 = new Position(nowX,nowY-1);
