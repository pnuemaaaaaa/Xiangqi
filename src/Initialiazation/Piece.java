...
public abstract class Piece {
    ...
    public boolean equals(Object obj) {
        System.out.println("【equals调用】this: " + this.getName() + " " + this.getPlayer() +
                " 位置:(" + this.getPosition().getX() + "," + this.getPosition().getY() + ")");
        System.out.println("【equals调用】obj: " + ((Piece)obj).getName() + " " + ((Piece)obj).getPlayer() +
                " 位置:(" + ((Piece)obj).getPosition().getX() + "," + ((Piece)obj).getPosition().getY() + ")");

        if (this == obj) return true;
        if (obj == null || getClass() != obj.getClass()) return false;
        Piece piece = (Piece) obj;

        boolean result = getPlayer() == piece.getPlayer() &&
                getName().equals(piece.getName()) &&
                getPosition().equals(piece.getPosition());

        System.out.println("【equals结果】: " + result);
        return result;
    }
